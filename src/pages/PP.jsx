...
import {Button as lol} from "@mui/material-next";
        ...
        return (
            <Container sx={{
                ...
                <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
                    ...
                    been created with the help of the <Button variant={"text"}
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to 買D餸, accessible from <Button variant={"text"}
                            href="https://whitenightawa.github.io/ict-sba/" rel="external nofollow noopener"
                            target="_blank">https://whitenightawa.github.io/ict-sba/</Button></p>
                    </li>
                    <li>
                ...
                <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on
                    ...
                    soon as You close Your web browser. Learn more about cookies on the <Button variant={"text"}
                        href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking"
                        target="_blank">Privacy Policies website</Button> article.</p>
                ...
                <ul>
                    <li>By email: evan.tang.2021@gmail.com</li>
                </ul>
            </Container>
        )
    }
